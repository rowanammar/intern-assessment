...
## Decision: Restart and resource settings
...
## Decision: Base image
- Choice: used alpine versions for postgres redis and NGINX
...
- Alternative: using the full normal images like ubuntu or debian
...
## Decision: Storage and restore scripts
